...
3. 基準に沿って影響レベル (low / medium / high) と判定 (skip-human-review / needs-human-review) を決める
4. 判定結果を Write ツールで `/tmp/claude-verdict.json` に以下の形式で書き出す:
...
- 判断に迷ったら必ず `needs-human-review` を選ぶ
